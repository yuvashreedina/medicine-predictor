...
def ask_ai_doctor(question, lang="English"):
    ...
    # Smoking related
    smoke_words = ["smoke","smoking","cigarette","tobacco","nicotine","bidi","hookah","vape","quit smoking","stop smoking","புகை","புகைபிடி"]
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    with col1:
        st.markdown("<div style='background:#e8f5e9;padding:1rem;border-radius:12px;border-left:4px solid #00a884;margin-bottom:1rem'><b>👨‍⚕️ Hi! I'm your AI Doctor.</b> Ask me about any medicine, symptom, or health concern — I'll give you clear, simple advice in English or Tamil!</div>",unsafe_allow_html=True)
    with col2:
        chat_lang=st.radio("Chat in",["English","தமிழ்"])
